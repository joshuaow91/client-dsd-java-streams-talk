...
export default function IntroductionToStreams({ isConcise }) {
  return (
      ...
      {isConcise ? (
        <>
          <p className="text-lg md:text-2xl mb-6 leading-8 md:leading-10">
            Java Streams offer a{" "}
            <span className="text-green-300 font-bold">
              functional approach
            </span>{" "}
            to efficiently process data collections, enabling operations like{" "}
            <span className="text-blue-300 font-bold">filtering</span>,{" "}
            <span className="text-blue-300 font-bold">mapping</span>, and{" "}
            <span className="text-blue-300 font-bold">reducing</span> without
            verbose code. Streams handle sequences of elements in{" "}
            <span className="text-green-300 font-bold">parallel</span> or{" "}
            <span className="text-green-300 font-bold">sequentially</span>,
...
// Result: ["Angela"]`}
        ...
        <>
          <p className="text-lg md:text-2xl mb-6 leading-8 md:leading-10">
            ...
            <span className="text-green-300 font-bold">parallel</span> or{" "}
            <span className="text-green-300 font-bold">sequentially</span>,
            reducing the need for verbose, boilerplate code. By leveraging the
            functional programming paradigm, streams allow for more readable,
          ...
          <p className="text-lg md:text-2xl mb-6 leading-8 md:leading-10">
            ...
            means focusing on{" "}
            <span className="text-blue-300 font-bold">what</span> needs to be
            done with the data rather than{" "}
          ...
          <p className="text-lg md:text-2xl mb-6 leading-8 md:leading-10">
            ...
            others that can be executed in a chain, enhancing the expressiveness
...
// Result: ["ANGELA"]`}
          ...
          <p className="text-lg md:text-2xl mt-6 leading-8 md:leading-10">
            This example demonstrates how a stream can filter a list to include
            only names that start with &apos;A&apos; and then map those names to
          ...
          <ul className="list-disc marker:text-pink-500 list-inside text-lg md:text-2xl mb-6 leading-8 md:leading-10">
            <li>
              <span className="text-green-300 font-bold">Conciseness</span>:
              Reduces boilerplate code, making code shorter and easier to read.
            </li>
            <li>
              <span className="text-green-300 font-bold">
                Parallel Processing
            ...
            <li>
              ...
              Promotes immutable operations, reducing the risk of side effects
              and enhancing code safety.
            </li>
            <li>
          ...
          <p className="text-lg md:text-2xl mb-6 leading-8 md:leading-10">
            In real-world applications, streams can be used to simplify complex
            data processing tasks. For example, processing large datasets,
            performing transformations, and aggregating results can all be done
            concisely with streams. They are particularly useful in scenarios
            such as data analysis, machine learning pipelines, and handling
...
// Result: Total salary of employees in the Sales department`}
          ...
          <p className="text-lg md:text-2xl mt-6 leading-8 md:leading-10">
            ...
            maps their salaries to a double stream, which is subsequently summed
            up. This showcases how streams can be effectively used to aggregate
            and compute results from data collections.
          </p>
        </>
      )}
    </div>
...
IntroductionToStreams.propTypes = {
